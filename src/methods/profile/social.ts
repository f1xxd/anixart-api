...
import { PROFILE_SOCIAL as endpoint } from "../../endpoints"

import type { IBaseApiParams } from "../../types"
import type { IProfileSocialResponse } from "../../schemas/profile"
...
export async function profileSocial(
  params: IProfileSocialParams
): Promise<IProfileSocialResult> {
