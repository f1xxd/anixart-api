...
export const COLLECTION_COMMENTS_VOTES =
  "collection/comment/votes/{commentId}/{page}"
...
export const SEARCH_PROFILE_COLLECTION =
  "search/profileCollections/{profileId}/{page}"
